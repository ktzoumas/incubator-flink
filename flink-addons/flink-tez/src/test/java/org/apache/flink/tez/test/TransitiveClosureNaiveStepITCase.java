...
import org.apache.flink.tez.examples.TransitiveClosureNaiveStep;

import java.io.BufferedReader;

public class TransitiveClosureNaiveStepITCase extends TezProgramTestBase {
    ...
    protected void testProgram() throws Exception {
        TransitiveClosureNaiveStep.main(edgesPath, resultPath, "5");
    }
